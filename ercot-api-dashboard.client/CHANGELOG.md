...
- Create Angular project with ng: `ng new ercot-api-dashboard.client --defaults --skip-install --skip-git --no-standalone `.
...
- Create project file (`ercot-api-dashboard.client.esproj`).
